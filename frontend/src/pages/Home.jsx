        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="text-center group">
              <div className="bg-green-50 rounded-2xl p-8 hover:bg-green-100 transition-colors duration-300">
                <div className="text-4xl md:text-5xl font-bold text-green-600 mb-2">
                  150+
                </div>
                <div className="text-lg font-semibold text-gray-900 mb-1">Tons Saved</div>
                <div className="text-sm text-gray-600">Agricultural waste prevented</div>
              </div>
            </div>
            
            <div className="text-center group">
              <div className="bg-blue-50 rounded-2xl p-8 hover:bg-blue-100 transition-colors duration-300">
                <div className="text-4xl md:text-5xl font-bold text-blue-600 mb-2">
                  35%
                </div>
                <div className="text-lg font-semibold text-gray-900 mb-1">Income Boost</div>
                <div className="text-sm text-gray-600">Average farmer increase</div>
              </div>
            </div>
            
            <div className="text-center group">
              <div className="bg-purple-50 rounded-2xl p-8 hover:bg-purple-100 transition-colors duration-300">
                <div className="text-4xl md:text-5xl font-bold text-purple-600 mb-2">
                  2.5K+
                </div>
                <div className="text-lg font-semibold text-gray-900 mb-1">Active Users</div>
                <div className="text-sm text-gray-600">In our network</div>
              </div>
            </div>
            
            <div className="text-center group">
              <div className="bg-orange-50 rounded-2xl p-8 hover:bg-orange-100 transition-colors duration-300">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">LKR 500M+</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">15 Districts</h3>
              <p className="text-gray-600">Coverage across Sri Lanka</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">92% Accuracy</h3>
              <p className="text-gray-600">AI crop demand prediction</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-semibold text-gray-900">Ranil Wickramasinghe</div>
                  <div className="text-green-600 text-sm">Organic Farmer, Kandy</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <p className="text-lg text-gray-700 mb-6 italic">
                "Finding reliable suppliers was always a challenge. Zerra connected me with verified farmers, reducing my procurement time by 80%."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-green-600 rounded-full flex items-center justify-center mr-4">
                ...
                <div>
                  <div className="font-semibold text-gray-900">Saman Jayawardena</div>
                  <div className="text-green-600 text-sm">Wholesale Buyer, Colombo</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="bg-green-50 rounded-2xl p-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  to="/signup" 
                  className="bg-green-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-green-700 transition-colors duration-300"
                >
                  Start Your Success Story
                </Link>
                <Link 
                  to="/login" 
                  className="bg-white border-2 border-green-600 text-green-600 px-8 py-4 rounded-xl font-semibold hover:bg-green-50 transition-colors duration-300"
                >
                  Access Dashboard
                </Link>
              </div>
